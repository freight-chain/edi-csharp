...
using System.Text;
    ...
    /// </summary>
    public class AS2MIMEUtilities2
    {
        public const string MESSAGE_SEPARATOR = "\r\n\r\n";
        public AS2MIMEUtilities2()
        {
        }
        ...
        internal static byte[] Encode(byte[] arMessage, X509Certificate2 cert)
        {
        ...
        public static byte[] Sign(byte[] arMessage, X509Certificate2 cert, out string sContentType)
        {
            ...
            // Get the signature.
            byte[] bSignature = Encode(arMessage, cert);
            // convert to base64
            ...
            string sig =  sb.ToString() + MESSAGE_SEPARATOR;
    ...
    {
        public static string MESSAGE_SEPARATOR = Environment.NewLine + Environment.NewLine;
        ...
        /// <param name="bPackageHeader"></param>
        /// <returns></returns>
        public static byte[] Sign(byte[] arMessage, object signerCert, string signerPassword, out string sContentType)
        {
            byte[] bInPKCS7 = new byte[0];
